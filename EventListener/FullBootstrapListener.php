...
/**
 * Class FullBootstrapListener
 * @package Bangpound\Bridge\Drupal\EventListener
 */
class FullBootstrapListener implements EventSubscriberInterface
{
     ...
     */
    public function onBootstrapFull(BootstrapEvent $event)
    {
